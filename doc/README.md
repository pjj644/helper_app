...
| 文档 | 职责与内容摘要 |
|---|---|
| [FEATURES.md](./FEATURES.md) | **全功能全景规格说明书**：智能课表 / 考务日程 / 成绩GPA / 全能日历 / 双校区班车 / AI伴随智能体 / 发现门户 / 桌面卡片 / 云同步与端到端加密 / 个性化设置全量 10 大子系统与 60+ 特性详单 |
...
| [SMOKE_CHECKLIST_P2.md](./SMOKE_CHECKLIST_P2.md) | **Phase 2 验收冒烟清单**：AGC 建表步骤 + 云同步/LWW/会话加密/导入预览逐例操作与预期（🔴 用户执行） |
| [RESEARCH_XIAOYI.md](./RESEARCH_XIAOYI.md) | **小艺接入调研**：意图框架四种接入方式对比、资质门槛、本地调试路径与风险（后续小艺轮次的现成方案） |
| [AGENT_ARCH_RESEARCH.md](./AGENT_ARCH_RESEARCH.md) | **Agent 架构评估与渐进式披露研究**：端云链路结构性缺陷清单（P0/P1 分级、含证据索引）/ 渐进式披露四层打分 / 对照 Antigravity 类 Harness 的能力映射 / M1-M16 分优先级移植建议（纯研究，不含代码改动） |
